...
Si osservi il seguente esempio costruito usando il database iris presente di default in \erre\ nel pacchetto datasets\fotonote{Si usi data() per vedere tutti dataset preinstallati in \erre. }
\begin{lstlisting}	
