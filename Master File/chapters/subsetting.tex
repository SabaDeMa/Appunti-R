...
\end{lstlisting}
Appare evidente che il secondo codice sia alquanto superfluo oltre che maldestro. Ovviamente ciò non sempre è vero. Un codice “maldestro” potrebbe risultare utile se il fine è quello di ottenere i dati in un’altra forma e quindi ricorrere alla opzione drop di subset\footnot{Di default imposta su FALSE}.
